...
-- Remove the prevent_multiple_neighborhoods trigger and function entirely
DROP TRIGGER IF EXISTS prevent_multiple_neighborhoods_trigger ON neighborhoods CASCADE;
DROP FUNCTION IF EXISTS public.prevent_multiple_neighborhoods() CASCADE;
