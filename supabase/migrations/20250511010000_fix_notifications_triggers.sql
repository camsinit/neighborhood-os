...
-- This migration fixes issues with notification triggers, particularly for RSVPs
-- It consolidates the notification creation logic and prevents duplicate notifications

-- First, let's drop any problematic triggers that might be causing duplicates
DROP TRIGGER IF EXISTS create_unified_notification ON event_rsvps;
DROP TRIGGER IF EXISTS create_rsvp_notification ON event_rsvps;

-- Now create a streamlined notification trigger for RSVPs
