...
export function HeroSection({
  ...
  return <section className={cn("bg-background text-foreground", "py-4 sm:py-12 md:py-16 px-4", "pb-0", "relative")}>
      ...
      <div className="mx-auto flex max-w-container flex-col gap-8 pt-8 sm:gap-16 pb-9 relative z-10 -mt-[50px] py-0">
          ...
          <div className="relative pt-[27px] w-full max-w-3xl mb-16">
            <div className="relative px-8 pb-8">
              ...
              <Mockup type="responsive">
                <img src="/lovable-uploads/f90db1c8-97ab-4bbc-8abd-5028d865c6e4.png" alt="Neighborhood dashboard interface showing Quick Actions and activity feed" width={1248} height={765} className="w-[calc(100%+150px)] sm:w-[calc(100%+160px)] h-auto rounded-[20px] drop-shadow-xl relative z-10 scale-[1.3] object-cover" />
              </Mockup>
            </div>
          </div>
        </div>
