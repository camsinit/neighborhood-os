          ...
          <div className="relative pt-8 w-full max-w-3xl mb-16">
            <div className="relative px-8 pb-8">
              ...
              <Mockup type="responsive">
                <img src="/lovable-uploads/f90db1c8-97ab-4bbc-8abd-5028d865c6e4.png" alt="Neighborhood dashboard interface showing Quick Actions and activity feed" width={1248} height={765} className="w-[calc(100%+160px)] h-auto rounded-t-2xl drop-shadow-xl relative z-10 scale-[1.3] pt-[40px] object-fill" />
              </Mockup>
            </div>
          </div>
        </div>
