          ...
          <div className="relative pt-8 w-full max-w-3xl mb-16">
            <div className="relative px-8 pb-8">
              ...
              <Mockup type="responsive">
                <img src={image.src} alt={image.alt} width={1248} height={765} className="w-[calc(100%+160px)] h-auto object-contain rounded-2xl drop-shadow-xl relative z-10 scale-[1.3]" />
              </Mockup>
            </div>
          </div>
        </div>
