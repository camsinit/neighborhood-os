  ...
  tabs = [
    {
      ...
      content: {
        ...
        description:
          "From borrowing tools to organizing events, our Quick Actions make it easy to connect with neighbors and get things done together.",
    ...
    },
    {
      ...
      content: {
        ...
        description:
          "Connect with neighbors who have the skills you need, or offer your expertise to help others. Building community through knowledge sharing.",
    ...
    },
    {
      ...
      content: {
        ...
        description:
          "Events, safety updates, goods exchange, and community discussions all in one place. Stay connected and engaged with what matters most.",
