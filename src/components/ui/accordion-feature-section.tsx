  ...
  return <section className="py-[10px]">
      <div className="container mx-auto px-4">
        <div className="mb-12 grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div ref={videoContainerRef} className="relative overflow-hidden rounded-xl bg-muted w-fit h-fit mx-auto flex items-center justify-center">
            {activeTabId === 5 ? (
              // Directory section shows the screenshot image
              <img 
                src="/lovable-uploads/a32964b8-235c-4ed7-82ca-2e3114b0079f.png"
              ...
              <video 
                ref={videoRef}
                src={currentVideoUrl}
                className="w-full h-auto max-h-80 rounded-md object-contain mt-8"
                muted
