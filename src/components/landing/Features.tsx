 ...
 * using a scroll-triggered animation that showcases the features in an engaging way.
 * Uses placeholder images that can be replaced with actual screenshots.
 */
const Features = () => {
  // Array of feature data objects with icons, titles, and descriptions
  const features = [{
        ...
        titleComponent={
          <>
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto mb-8">
              Nextdoor became a message board for complaints and missing cats. We help your neighborhood become an invaluable resource for connection, care, and community.
            </p>
          </>
        }
      >
        {/* Placeholder image that will be replaced */}
        <img
          src="https://images.unsplash.com/photo-1649972904349-6e44c42644a7?w=1400&h=720&fit=crop"
          alt="neighborhoodOS dashboard preview showing community features"
          className="mx-auto rounded-2xl object-cover h-full w-full"
        />
      </ContainerScroll>

      {/* Feature grid below the scroll animation */}
      <div className="mx-auto max-w-6xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pb-16 mt-8">
