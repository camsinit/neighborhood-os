...
const Features = () => {
  ...
  return <section className="py-0 px-8 md:px-16 lg:px-24 bg-background pb-16">
      ...
      <div className="mx-auto max-w-6xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pb-8">
        {features.map((feature, index) => <div key={index} className={`border ${feature.borderColor} rounded-xl p-7 flex flex-col gap-4 transition-all duration-200 hover:shadow-md hover:border-primary/50`}>
