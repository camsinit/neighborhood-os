...
const Features = () => {
  ...
  const neighborhoodFeatures = [{
    ...
    replaces: [
      { name: "OfferUp", logo: "https://img.logo.dev/offerup.com?token=pk_SdwwezRcTT6rDwqgpowtPg", alt: "OfferUp", url: "https://offerup.com" },
      { name: "Craigslist", logo: "https://img.logo.dev/craigslist.org?token=pk_SdwwezRcTT6rDwqgpowtPg", alt: "Craigslist", url: "https://craigslist.org" },
      { name: "Facebook Marketplace", logo: "https://img.logo.dev/facebook.com?token=pk_SdwwezRcTT6rDwqgpowtPg", alt: "Facebook Marketplace", url: "https://facebook.com/marketplace" }
    ]
  }, {
    id: 3,
    title: "Skills",
    ...
    replaces: [
      ...
      { name: "Citizen", logo: "https://img.logo.dev/citizen.com?token=pk_SdwwezRcTT6rDwqgpowtPg", alt: "Citizen", url: "https://citizen.com" }
    ]
  }, {
    id: 5,
    title: "Directory",
    ...
    replaces: [
      ...
      { name: "Google Sheets", logo: "/lovable-uploads/996c0ed3-9cf1-4421-93dd-6daeb88b064d.png", alt: "Google Sheets", url: "https://workspace.google.com/products/sheets/" }
    ]
  }];
