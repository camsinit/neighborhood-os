...
export const CategoryList = ({
  ...
  return <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-8 px-0 my-0 mx-0">
      {categories.map(category => <button key={category.id} onClick={() => onCategorySelect(category.id)} className="flex items-center p-6 rounded-lg border border-gray-100 bg-white transition-all hover:scale-[1.02] shadow-[0_2px_8px_rgba(0,0,0,0.08)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.12)]">
