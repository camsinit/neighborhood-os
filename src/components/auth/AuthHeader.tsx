...
const AuthHeader = () => {
  return (
    <div className="text-center mb-6 relative z-10"> {/* Added z-index and margin */}
      ...
      <h2 className={cn(
        ...
        "text-3xl font-semibold leading-tight text-transparent drop-shadow-2xl",
      ...
      <p className="mt-2 text-md font-medium text-muted-foreground">
        Login to see your neighborhood!
      </p>
    </div>
  );
};
