...
import AvailableFreebiesSection from './AvailableFreebiesSection';
import { GoodsExchangeItem } from '@/types/localTypes';

interface FreebiesSearchBarProps {
  searchQuery: string;
...
export default FreebiesSearchBar;
