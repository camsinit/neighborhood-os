...
interface RequestFreebiesCardProps {
  request: GoodsExchangeItem;
  onSelect: () => void;
}

const RequestFreebiesCard: React.FC<RequestFreebiesCardProps> = ({
  request,
  onSelect
}) => {
  ...
  return (
    <BaseFreebiesCard onClick={onSelect}>
...
export default RequestFreebiesCard;
