...
import FreebiesRequestsSection from '../FreebiesRequestsSection';

interface RegularFreebiesSectionProps {
...
const RegularFreebiesSection: React.FC<RegularFreebiesSectionProps> = ({
  requests,
  urgentRequests,
  onRequestSelect,
  onDeleteItem,
  ...
  return (
    <div className="space-y-2">
      <FreebiesRequestsSection 
        freebiesRequests={requests} 
...
export default RegularFreebiesSection;
