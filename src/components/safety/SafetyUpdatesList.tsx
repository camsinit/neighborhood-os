    ...
    <div>
      <div className="flex items-center gap-4 mb-6 px-0 py-0">
        <Input 
          ...
          className="max-w-sm bg-white border-gray-200 focus:ring-amber-200 focus:border-amber-300 h-10 rounded-md" 
        />
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button 
              variant="outline" 
              size="sm" 
              className="text-gray-600 border-gray-200 bg-white rounded-md"
            >
        ...
        <Button 
          onClick={onAddUpdate} 
          className="bg-red-500 hover:bg-red-600 text-white ml-auto rounded-md"
        >
