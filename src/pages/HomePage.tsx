 ...
 * Notifications now inline with Quick Actions section heading with enhanced visibility
 */
const HomePage = () => {
  return (
    <div className="w-full px-4 sm:px-6 lg:px-8 py-4">
      <div className="max-w-7xl mx-auto">
        <div className="space-y-6">
          {/* Quick Actions Section with Enhanced Notifications Button */}
          <section>
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-2xl font-bold text-gray-900">Quick Actions</h2>
              {/* The NotificationDrawer component now contains our enhanced button */}
              <NotificationDrawer />
            </div>
            <QuickActions />
          </section>
